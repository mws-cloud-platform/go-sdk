...
func decodeListHmacKeyResponse(resp *http.Response) (*client.ListHmacKeyResponse, error) {
...
func decodeDeleteHmacKeyResponse(resp *http.Response) (*client.DeleteHmacKeyResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
...
func decodeGetHmacKeyResponse(resp *http.Response) (*client.GetHmacKeyResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
...
func decodeUpsertHmacKeyResponse(resp *http.Response) (*client.UpsertHmacKeyResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
