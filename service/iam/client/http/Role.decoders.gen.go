...
func decodeListGlobalRoleV2Response(resp *http.Response) (*client.ListGlobalRoleV2Response, error) {
	...
	case 200:
		...
		case "application/json":
			result := &client.ListGlobalRoleV2Response{
...
func decodeGetGlobalRoleV2Response(resp *http.Response) (*client.GetGlobalRoleV2Response, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.GetGlobalRoleV2Response{
				Code:        resp.StatusCode,
