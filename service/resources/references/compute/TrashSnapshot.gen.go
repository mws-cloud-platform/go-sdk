...
func (m *TrashSnapshotID) AsRef() *TrashSnapshotRef {
	if m == nil {
		return nil
	}
	return &TrashSnapshotRef{
		id: *m,
	}
}

func (m *TrashSnapshotID) Equal(other *TrashSnapshotID) bool {
	if m == other {
		return true
	}
	if m == nil || other == nil {
...
func (m *TrashSnapshotRef) Equal(other *TrashSnapshotRef) bool {
	if m == other {
		return true
	}
	if m == nil || other == nil {
