...
func (m *FolderCountID) AsRef() *FolderCountRef {
	if m == nil {
		return nil
	}
	return &FolderCountRef{
		id: *m,
	}
}

func (m *FolderCountID) Equal(other *FolderCountID) bool {
	if m == other {
		return true
	}
	if m == nil || other == nil {
...
func (m *FolderCountID) Encode(e *jx.Encoder) error {
	if m == nil {
		e.Null()
		return nil
	}
...
func (m *FolderCountRef) Equal(other *FolderCountRef) bool {
	if m == other {
		return true
	}
	if m == nil || other == nil {
...
func (m *FolderCountRef) Encode(e *jx.Encoder) error {
	if m == nil {
		e.Null()
		return nil
	}
