...
func (m *SystemServiceAccountID) AsRef() *SystemServiceAccountRef {
	if m == nil {
		return nil
	}
	return &SystemServiceAccountRef{
		id: *m,
	}
}

func (m *SystemServiceAccountID) Equal(other *SystemServiceAccountID) bool {
	if m == other {
		return true
	}
	if m == nil || other == nil {
	...
	return m.systemServiceAccounts == other.systemServiceAccounts
}
...
func (m *SystemServiceAccountID) Decode(d *jx.Decoder) error {
	if m == nil {
		return conv.NewDecodeToNilError("SystemServiceAccountID")
	}
...
func (m *SystemServiceAccountRef) Equal(other *SystemServiceAccountRef) bool {
	if m == other {
		return true
	}
	if m == nil || other == nil {
	...
	return m.id.systemServiceAccounts == other.id.systemServiceAccounts
}
