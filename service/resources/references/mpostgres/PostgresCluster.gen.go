...
func (m *PostgresClusterID) AsRef() *PostgresClusterRef {
	if m == nil {
		return nil
	}
	return &PostgresClusterRef{
		id: *m,
	}
}

func (m *PostgresClusterID) Equal(other *PostgresClusterID) bool {
	if m == other {
		return true
	}
	if m == nil || other == nil {
...
func (m *PostgresClusterRef) Equal(other *PostgresClusterRef) bool {
	if m == other {
		return true
	}
	if m == nil || other == nil {
