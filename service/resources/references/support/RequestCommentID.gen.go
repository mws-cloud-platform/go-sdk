...
func NewRequestCommentIDID(requestName, commentName string) RequestCommentIDID {
...
func (m *RequestCommentIDID) Parse(ctx context.Context) error {
	...
	result, err := resparsers.Reference(ctx, m.path, RequestCommentIDRefTemplate.AsID())
	if err != nil {
...
func NewRequestCommentIDRef(requestName, commentName string) RequestCommentIDRef {
...
func (m *RequestCommentIDRef) Parse(ctx context.Context) error {
	...
	result, err := resparsers.Reference(ctx, m.id.path, RequestCommentIDRefTemplate)
	if err != nil {
