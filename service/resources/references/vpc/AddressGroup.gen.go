...
func (m *AddressGroupID) String() string {
	return m.ID()
}
...
func (m *AddressGroupID) Encode(e *jx.Encoder) error {
	if m == nil {
		e.Null()
		return nil
	}
...
func (m *AddressGroupID) Decode(d *jx.Decoder) error {
	if m == nil {
		return conv.NewDecodeToNilError("AddressGroupID")
	}
...
func (m *AddressGroupRef) String() string {
	return m.IDPath()
}
...
func (m *AddressGroupRef) Encode(e *jx.Encoder) error {
	if m == nil {
		e.Null()
		return nil
	}
