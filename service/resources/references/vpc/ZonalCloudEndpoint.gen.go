...
func (m *ZonalCloudEndpointID) Encode(e *jx.Encoder) error {
	if m == nil {
		e.Null()
		return nil
	}
...
func (m *ZonalCloudEndpointID) Decode(d *jx.Decoder) error {
	if m == nil {
		return conv.NewDecodeToNilError("ZonalCloudEndpointID")
	}
...
func (m *ZonalCloudEndpointRef) Encode(e *jx.Encoder) error {
	if m == nil {
		e.Null()
		return nil
	}
