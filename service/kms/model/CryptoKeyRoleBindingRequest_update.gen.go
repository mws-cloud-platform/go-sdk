...
func (m *CryptoKeyRoleBindingRequest) AsUpdateModel() UpdateCryptoKeyRoleBindingRequest {
	var u UpdateCryptoKeyRoleBindingRequest
	if m.Metadata != nil {
...
func (m *CryptoKeyRoleBindingRequest) Diff(src *CryptoKeyRoleBindingRequest) UpdateCryptoKeyRoleBindingRequest {
	nilDiffers := src != nil && m == nil
	upd := UpdateCryptoKeyRoleBindingRequest{}
	if !nilDiffers {
...
func (m *CryptoKeyRoleBindingRequest) WithChanges(u UpdateCryptoKeyRoleBindingRequest) CryptoKeyRoleBindingRequest {
	var out CryptoKeyRoleBindingRequest
	if m != nil {
		out = *m
	}
...
func (m UpdateCryptoKeyRoleBindingRequest) HasChanges() bool {
	return m.Metadata.Set ||
		m.Spec.Set
}

func (m *UpdateCryptoKeyRoleBindingRequest) Parse(ctx context.Context) error {
	if m == nil {
		return nil
	}
