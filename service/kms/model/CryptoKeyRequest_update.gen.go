...
type UpdateCryptoKeyRequest struct {
	...
	Spec     optional.Optional[UpdateCryptoKeySpecRequest]                              `json:"spec" yaml:"spec"`
}

func (m *CryptoKeyRequest) AsUpdateModel() UpdateCryptoKeyRequest {
	var u UpdateCryptoKeyRequest
	if m.Metadata != nil {
...
func (m *CryptoKeyRequest) Diff(src *CryptoKeyRequest) UpdateCryptoKeyRequest {
	nilDiffers := src != nil && m == nil
	upd := UpdateCryptoKeyRequest{}
	if !nilDiffers {
...
func (m *CryptoKeyRequest) WithChanges(u UpdateCryptoKeyRequest) CryptoKeyRequest {
...
func (m UpdateCryptoKeyRequest) HasChanges() bool {
	return m.Metadata.Set ||
		m.Spec.Set
}

func (m *UpdateCryptoKeyRequest) Parse(ctx context.Context) error {
	if m == nil {
		return nil
	}
...
func (m *CryptoKeyRequest) diffMetadata(src *CryptoKeyRequest) optional.OptionalNil[commonmodel.UpdateCommonTypedResourceMetadataRequest] {
	nilDiffers := src != nil && m == nil
...
func (m *CryptoKeyRequest) diffSpec(src *CryptoKeyRequest) optional.Optional[UpdateCryptoKeySpecRequest] {
	from := src.GetSpec()
	to := m.GetSpec()
	value := to.Diff(&from)
	return optional.Optional[UpdateCryptoKeySpecRequest]{
		Value: value,
