...
// Real OAPI model name: ReEncryptRequest
type ReEncryptRequestRequest struct {
	// Зашифрованные данные, которые необходимо повторно зашифровать.
...
func (m *ReEncryptRequestRequest) GetCiphertext() []byte {
	if m != nil {
		return m.Ciphertext
	}
	return nil
...
func (m *ReEncryptRequestRequest) SetCiphertext(val []byte) {
	m.Ciphertext = val
}

func (m *ReEncryptRequestRequest) GetSourceKeyRef() *kms.CryptoKeyRef {
	if m != nil {
...
func (m *ReEncryptRequestRequest) SetSourceKeyRef(val *kms.CryptoKeyRef) {
	m.SourceKeyRef = val
}

func (m *ReEncryptRequestRequest) GetSourceKeyRefOr(val kms.CryptoKeyRef) kms.CryptoKeyRef {
...
func (m *ReEncryptRequestRequest) GetSourceAssociatedData() []byte {
	if m != nil {
...
func (m *ReEncryptRequestRequest) SetSourceAssociatedData(val []byte) {
	m.SourceAssociatedData = val
}

func (m *ReEncryptRequestRequest) GetSourceAssociatedDataOr(val []byte) []byte {
...
func (m *ReEncryptRequestRequest) GetDestinationAssociatedData() []byte {
	if m != nil {
...
func (m *ReEncryptRequestRequest) SetDestinationAssociatedData(val []byte) {
	m.DestinationAssociatedData = val
}

func (m *ReEncryptRequestRequest) GetDestinationAssociatedDataOr(val []byte) []byte {
...
func (m *ReEncryptRequestRequest) GetDestinationVersion() *int32 {
	if m != nil {
...
func (m *ReEncryptRequestRequest) SetDestinationVersion(val *int32) {
	m.DestinationVersion = val
}

func (m *ReEncryptRequestRequest) GetDestinationVersionOr(val int32) int32 {
...
func (m *ReEncryptRequestRequest) Clone() *ReEncryptRequestRequest {
	if m == nil {
		return nil
	}
...
func (m *ReEncryptRequestRequest) Parse(ctx context.Context) error {
	if m == nil {
		return nil
	}
