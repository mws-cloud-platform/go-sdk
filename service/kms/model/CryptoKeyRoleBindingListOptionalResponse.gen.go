...
func (m *CryptoKeyRoleBindingListOptionalResponse) SetItems(val []CryptoKeyRoleBindingOptionalResponse) {
	m.Items = val
}
...
func (m *CryptoKeyRoleBindingListOptionalResponse) Clone() *CryptoKeyRoleBindingListOptionalResponse {
	if m == nil {
		return nil
	}
	...
	clone := *m
	if m.Items != nil {
		clone.Items = make([]CryptoKeyRoleBindingOptionalResponse, len(m.Items))
...
func (m *CryptoKeyRoleBindingListOptionalResponse) Parse(ctx context.Context) error {
	if m == nil {
		return nil
	}
...
func (m CryptoKeyRoleBindingListOptionalResponse) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
...
func (m *CryptoKeyRoleBindingListOptionalResponse) Encode(e *jx.Encoder) error {
	if m == nil {
		e.Null()
		return nil
	}
...
func (m *CryptoKeyRoleBindingListOptionalResponse) encodeFields(e *jx.Encoder) error {
	e.FieldStart("items")
	e.ArrStart()
...
func (m *CryptoKeyRoleBindingListOptionalResponse) UnmarshalJSON(b []byte) error {
	return m.Decode(jx.DecodeBytes(b))
}

func (m *CryptoKeyRoleBindingListOptionalResponse) Decode(d *jx.Decoder) error {
	if m == nil {
		return conv.NewDecodeToNilError("CryptoKeyRoleBindingListOptionalResponse")
	}

	return d.ObjBytes(reserrors.PathAccumulatorErrorObjBytesFuncWrap(func(d *jx.Decoder, k []byte) error {
		switch string(k) {
		case "items":
			c := make([]CryptoKeyRoleBindingOptionalResponse, 0)
			if err := d.Arr(reserrors.PathAccumulatorErrorAsIndexArrFuncWrap(func(d *jx.Decoder) error {
				var v CryptoKeyRoleBindingOptionalResponse
