...
func decodeListCryptoKeyRoleBindingsResponse(resp *http.Response) (*client.ListCryptoKeyRoleBindingsResponse, error) {
...
func decodeDeleteCryptoKeyRoleBindingResponse(resp *http.Response) (*client.DeleteCryptoKeyRoleBindingResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
...
func decodeGetCryptoKeyRoleBindingResponse(resp *http.Response) (*client.GetCryptoKeyRoleBindingResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
...
func decodeUpsertCryptoKeyRoleBindingResponse(resp *http.Response) (*client.UpsertCryptoKeyRoleBindingResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
