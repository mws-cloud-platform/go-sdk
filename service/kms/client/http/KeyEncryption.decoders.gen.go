...
func decodeGenerateDataKeyResponse(resp *http.Response) (*client.GenerateDataKeyResponse, error) {
...
func decodeEncryptResponse(resp *http.Response) (*client.EncryptResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
...
func decodeDecryptResponse(resp *http.Response) (*client.DecryptResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
...
func decodeReEncryptResponse(resp *http.Response) (*client.ReEncryptResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
