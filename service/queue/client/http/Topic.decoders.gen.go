...
func decodeListTopicsResponse(resp *http.Response) (*client.ListTopicsResponse, error) {
	...
	case 200:
		...
		case "application/json":
			result := &client.ListTopicsResponse{
...
func decodeDeleteTopicResponse(resp *http.Response) (*client.DeleteTopicResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	switch resp.StatusCode {
	case 204:
		result := &client.DeleteTopicResponse{
			Code:        resp.StatusCode,
			Response204: true,
		}
...
func decodeGetTopicResponse(resp *http.Response) (*client.GetTopicResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.GetTopicResponse{
				Code:        resp.StatusCode,
...
func decodeUpsertTopicResponse(resp *http.Response) (*client.UpsertTopicResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.UpsertTopicResponse{
				Code:        resp.StatusCode,
				Response200: &model.TopicOptionalResponse{},
			}
