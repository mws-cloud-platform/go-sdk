...
func decodeListGroupsResponse(resp *http.Response) (*client.ListGroupsResponse, error) {
	...
	case 200:
		...
		case "application/json":
			result := &client.ListGroupsResponse{
...
func decodeGetConsumerGroupResponse(resp *http.Response) (*client.GetConsumerGroupResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.GetConsumerGroupResponse{
				Code:        resp.StatusCode,
