...
func decodeListTopicRoleBindingsResponse(resp *http.Response) (*client.ListTopicRoleBindingsResponse, error) {
	...
	case 200:
		...
		case "application/json":
			result := &client.ListTopicRoleBindingsResponse{
...
func decodeDeleteTopicRoleBindingResponse(resp *http.Response) (*client.DeleteTopicRoleBindingResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	switch resp.StatusCode {
	case 204:
		result := &client.DeleteTopicRoleBindingResponse{
			Code:        resp.StatusCode,
			Response204: true,
		}
...
func decodeGetTopicRoleBindingResponse(resp *http.Response) (*client.GetTopicRoleBindingResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.GetTopicRoleBindingResponse{
				Code:        resp.StatusCode,
...
func decodeUpsertTopicRoleBindingResponse(resp *http.Response) (*client.UpsertTopicRoleBindingResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.UpsertTopicRoleBindingResponse{
				Code:        resp.StatusCode,
				Response200: &commonmodel.CommonRoleBindingOptionalResponse{},
			}
