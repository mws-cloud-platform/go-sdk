...
func CollectorTypedResourceMetadataRequestToOptionalResponse(request *CollectorTypedResourceMetadataRequest) (*CollectorTypedResourceMetadataOptionalResponse, error) {
	if request == nil {
		return nil, nil
	}
	var response CollectorTypedResourceMetadataOptionalResponse
