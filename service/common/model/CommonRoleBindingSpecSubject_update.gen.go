...
type UpdateCommonRoleBindingSpecSubject struct {
	...
	WorkloadFederation optional.OptionalNil[UpdateCommonRoleBindingWorkloadFederation] `json:"workloadFederation" yaml:"workloadFederation"`
	// Идентификатор группы пользователей.
	UserGroup optional.Optional[iam.UserGroupRef] `json:"userGroup" yaml:"userGroup"`
	// Идентификатор пользователя backoffice.
	Employee optional.Optional[iam.EmployeeRef] `json:"employee" yaml:"employee"`
}
...
func (m *CommonRoleBindingSpecSubject) AsUpdateModel() UpdateCommonRoleBindingSpecSubject {
	...
	if m.Employee != nil {
		u.Employee = optional.NewOptional(m.GetEmployeeOr(iam.EmployeeRef{}))
	}
	return u
}
...
func (m *CommonRoleBindingSpecSubject) WithChanges(u UpdateCommonRoleBindingSpecSubject) CommonRoleBindingSpecSubject {
	...
	if u.Employee.IsSet() {
		out.Employee = ptr.Get(u.Employee.Value)
	}
	return out
}
...
func (m *CommonRoleBindingSpecSubject) diffWorkloadFederation(src *CommonRoleBindingSpecSubject) optional.OptionalNil[UpdateCommonRoleBindingWorkloadFederation] {
	nilDiffers := src != nil && m == nil
	value := m.GetWorkloadFederation().Diff(src.GetWorkloadFederation())
	return optional.OptionalNil[UpdateCommonRoleBindingWorkloadFederation]{
		Value: value,
		Set:   nilDiffers || value.HasChanges(),
		Null:  nilDiffers,
	}
...
func (m *CommonRoleBindingSpecSubject) diffEmployee(src *CommonRoleBindingSpecSubject) optional.Optional[iam.EmployeeRef] {
	nilDiffers := src != nil && m == nil
	return commonclient.DiffPrimitiveNonRequired(src.GetEmployee(), m.GetEmployee(), nilDiffers)
}
