...
func (m *CommonRoleBindingFederationContextAttributeOptionalResponse) Encode(e *jx.Encoder) {
	if m == nil {
		e.Null()
		return
	}
...
func (m *CommonRoleBindingFederationContextAttributeOptionalResponse) encodeFields(e *jx.Encoder) {
	e.FieldStart("name")
	e.Str(m.Name)
