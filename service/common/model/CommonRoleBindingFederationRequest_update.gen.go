...
func (m *CommonRoleBindingFederationRequest) diffContext(src *CommonRoleBindingFederationRequest) optional.OptionalNil[UpdateCommonRoleBindingFederationContextRequest] {
	nilDiffers := src != nil && m == nil
