...
func (m *TypedUsage) diffName(src *TypedUsage) optional.Optional[string] {
	nilDiffers := src != nil && m == nil
	return commonclient.DiffPrimitiveRequired(src.GetName(), m.GetName(), nilDiffers)
}

func (m *TypedUsage) diffResource(src *TypedUsage) optional.Optional[resmodels.AnyResourceID] {
	nilDiffers := src != nil && m == nil
