...
func (m *TypedUsageRequest) Diff(src *TypedUsageRequest) UpdateTypedUsageRequest {
	nilDiffers := src != nil && m == nil
	upd := UpdateTypedUsageRequest{}
	if !nilDiffers {
...
func (m *TypedUsageRequest) WithChanges(u UpdateTypedUsageRequest) TypedUsageRequest {
	var out TypedUsageRequest
	if m != nil {
		out = *m
	}
...
func (m UpdateTypedUsageRequest) HasChanges() bool {
...
func (m *UpdateTypedUsageRequest) GetName() string {
	if m.Name.IsSet() {
		return m.Name.Value
	}
	return ""
