...
func (m *UpdateCommonRoleBindingSpecSubject) Decode(d *jx.Decoder) error {
	if m == nil {
		return conv.NewDecodeToNilError("UpdateCommonRoleBindingSpecSubject")
	}
	...
	return d.ObjBytes(reserrors.PathAccumulatorErrorObjBytesFuncWrap(func(d *jx.Decoder, k []byte) error {
		...
		case "userFederation":
			...
			var v UpdateCommonRoleBindingFederation
			if err := v.Decode(d); err != nil {
				return err
			}
		...
		case "workloadFederation":
			...
			var v UpdateCommonRoleBindingWorkloadFederation
			if err := v.Decode(d); err != nil {
				return err
			}
