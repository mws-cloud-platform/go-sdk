...
func decodeGetSerialPortOutputResponse(resp *http.Response) (*client.GetSerialPortOutputResponse, error) {
...
func decodeGetComputeSerialPortOutputResponse(resp *http.Response) (*client.GetComputeSerialPortOutputResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
