...
func decodeListZonesResponse(resp *http.Response) (*client.ListZonesResponse, error) {
	...
	case 200:
		...
		case "application/json":
			result := &client.ListZonesResponse{
...
func decodeGetZoneResponse(resp *http.Response) (*client.GetZoneResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
