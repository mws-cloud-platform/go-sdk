...
func decodeListRegionsResponse(resp *http.Response) (*client.ListRegionsResponse, error) {
	...
	case 200:
		...
		case "application/json":
			result := &client.ListRegionsResponse{
...
func decodeGetRegionResponse(resp *http.Response) (*client.GetRegionResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.GetRegionResponse{
				Code:        resp.StatusCode,
