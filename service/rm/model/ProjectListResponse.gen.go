...
func (m *ProjectListResponse) SetItems(val []ProjectResponse) {
	m.Items = val
}
...
func (m *ProjectListResponse) Clone() *ProjectListResponse {
	if m == nil {
		return nil
	}
	...
	clone := *m
	if m.Items != nil {
		clone.Items = make([]ProjectResponse, len(m.Items))
...
func (m *ProjectListResponse) Parse(ctx context.Context) error {
	if m == nil {
		return nil
	}
...
func (m *ProjectListResponse) Encode(e *jx.Encoder) error {
	if m == nil {
		e.Null()
		return nil
	}
...
func (m *ProjectListResponse) encodeFields(e *jx.Encoder) error {
	e.FieldStart("items")
	e.ArrStart()
...
func (m *ProjectListResponse) Decode(d *jx.Decoder) error {
	if m == nil {
		return conv.NewDecodeToNilError("ProjectListResponse")
	}

	return d.ObjBytes(reserrors.PathAccumulatorErrorObjBytesFuncWrap(func(d *jx.Decoder, k []byte) error {
		switch string(k) {
		case "items":
			c := make([]ProjectResponse, 0)
