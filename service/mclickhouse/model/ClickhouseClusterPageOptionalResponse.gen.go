...
func (m *ClickhouseClusterPageOptionalResponse) SetItems(val []ClickhouseClusterOptionalResponse) {
	m.Items = val
}
...
func (m *ClickhouseClusterPageOptionalResponse) Clone() *ClickhouseClusterPageOptionalResponse {
	if m == nil {
		return nil
	}
	...
	clone := *m
	if m.Items != nil {
		clone.Items = make([]ClickhouseClusterOptionalResponse, len(m.Items))
...
func (m *ClickhouseClusterPageOptionalResponse) Parse(ctx context.Context) error {
	if m == nil {
		return nil
	}
...
func (m ClickhouseClusterPageOptionalResponse) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
...
func (m *ClickhouseClusterPageOptionalResponse) Encode(e *jx.Encoder) error {
	if m == nil {
		e.Null()
		return nil
	}
...
func (m *ClickhouseClusterPageOptionalResponse) encodeFields(e *jx.Encoder) error {
	e.FieldStart("items")
	e.ArrStart()
...
func (m *ClickhouseClusterPageOptionalResponse) UnmarshalJSON(b []byte) error {
	return m.Decode(jx.DecodeBytes(b))
}

func (m *ClickhouseClusterPageOptionalResponse) Decode(d *jx.Decoder) error {
	if m == nil {
		return conv.NewDecodeToNilError("ClickhouseClusterPageOptionalResponse")
	}

	return d.ObjBytes(reserrors.PathAccumulatorErrorObjBytesFuncWrap(func(d *jx.Decoder, k []byte) error {
		switch string(k) {
		case "items":
			c := make([]ClickhouseClusterOptionalResponse, 0)
			if err := d.Arr(reserrors.PathAccumulatorErrorAsIndexArrFuncWrap(func(d *jx.Decoder) error {
				var v ClickhouseClusterOptionalResponse
