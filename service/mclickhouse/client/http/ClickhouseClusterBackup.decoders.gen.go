...
func decodeListClickhouseClusterBackupsResponse(resp *http.Response) (*client.ListClickhouseClusterBackupsResponse, error) {
	...
	case 200:
		...
		case "application/json":
			result := &client.ListClickhouseClusterBackupsResponse{
...
func decodeDeleteClickhouseClusterBackupResponse(resp *http.Response) (*client.DeleteClickhouseClusterBackupResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	switch resp.StatusCode {
	case 204:
		result := &client.DeleteClickhouseClusterBackupResponse{
			Code:        resp.StatusCode,
			Response204: true,
		}
...
func decodeGetClickhouseClusterBackupResponse(resp *http.Response) (*client.GetClickhouseClusterBackupResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.GetClickhouseClusterBackupResponse{
				Code:        resp.StatusCode,
...
func decodeUpsertClickhouseClusterBackupResponse(resp *http.Response) (*client.UpsertClickhouseClusterBackupResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.UpsertClickhouseClusterBackupResponse{
				Code:        resp.StatusCode,
				Response200: &model.ClickhouseBackupOptionalResponse{},
			}
