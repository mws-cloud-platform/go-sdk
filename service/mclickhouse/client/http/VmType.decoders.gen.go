...
func decodeGetClickhouseClusterVmTypesResponse(resp *http.Response) (*client.GetClickhouseClusterVmTypesResponse, error) {
	...
	case 200:
		...
		case "application/json":
			result := &client.GetClickhouseClusterVmTypesResponse{
