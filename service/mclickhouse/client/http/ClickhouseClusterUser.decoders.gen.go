...
func decodeListClickhouseClusterUsersResponse(resp *http.Response) (*client.ListClickhouseClusterUsersResponse, error) {
	...
	case 200:
		...
		case "application/json":
			result := &client.ListClickhouseClusterUsersResponse{
...
func decodeUpdateClickhouseClusterUserResponse(resp *http.Response) (*client.UpdateClickhouseClusterUserResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.UpdateClickhouseClusterUserResponse{
				Code:        resp.StatusCode,
