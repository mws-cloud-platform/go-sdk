...
func decodeListRoleBindingsResponse(resp *http.Response) (*client.ListRoleBindingsResponse, error) {
	...
	case 200:
		...
		case "application/json":
			result := &client.ListRoleBindingsResponse{
...
func decodeDeleteRoleBindingResponse(resp *http.Response) (*client.DeleteRoleBindingResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	switch resp.StatusCode {
	case 204:
		result := &client.DeleteRoleBindingResponse{
			Code:        resp.StatusCode,
			Response204: true,
		}
...
func decodeGetRoleBindingResponse(resp *http.Response) (*client.GetRoleBindingResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.GetRoleBindingResponse{
				Code:        resp.StatusCode,
...
func decodeUpsertRoleBindingResponse(resp *http.Response) (*client.UpsertRoleBindingResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.UpsertRoleBindingResponse{
				Code:        resp.StatusCode,
				Response200: &model.SecretRoleBindingOptionalResponse{},
			}
