...
func SecretVersionRequestToOptionalResponse(request *SecretVersionRequest) (*SecretVersionOptionalResponse, error) {
	if request == nil {
		return nil, nil
	}
	var response SecretVersionOptionalResponse
