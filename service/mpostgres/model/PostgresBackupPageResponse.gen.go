...
func (m PostgresBackupPageResponse) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
...
func (m *PostgresBackupPageResponse) Encode(e *jx.Encoder) error {
	if m == nil {
		e.Null()
		return nil
	}
...
func (m *PostgresBackupPageResponse) encodeFields(e *jx.Encoder) error {
	e.FieldStart("items")
	e.ArrStart()
...
func (m *PostgresBackupPageResponse) UnmarshalJSON(b []byte) error {
	return m.Decode(jx.DecodeBytes(b))
}

func (m *PostgresBackupPageResponse) Decode(d *jx.Decoder) error {
	if m == nil {
		return conv.NewDecodeToNilError("PostgresBackupPageResponse")
	}

	return d.ObjBytes(reserrors.PathAccumulatorErrorObjBytesFuncWrap(func(d *jx.Decoder, k []byte) error {
		switch string(k) {
		case "items":
			c := make([]PostgresBackupResponse, 0)
			if err := d.Arr(reserrors.PathAccumulatorErrorAsIndexArrFuncWrap(func(d *jx.Decoder) error {
				var v PostgresBackupResponse
