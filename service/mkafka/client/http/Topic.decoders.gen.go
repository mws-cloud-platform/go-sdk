...
func decodeListKafkaTopicsResponse(resp *http.Response) (*client.ListKafkaTopicsResponse, error) {
...
func decodeDeleteKafkaTopicResponse(resp *http.Response) (*client.DeleteKafkaTopicResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
...
func decodeGetKafkaTopicResponse(resp *http.Response) (*client.GetKafkaTopicResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
...
func decodeUpsertKafkaTopicResponse(resp *http.Response) (*client.UpsertKafkaTopicResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
