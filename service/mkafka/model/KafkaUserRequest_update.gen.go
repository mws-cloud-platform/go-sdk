...
func (m *KafkaUserRequest) Diff(src *KafkaUserRequest) UpdateKafkaUserRequest {
	nilDiffers := src != nil && m == nil
	upd := UpdateKafkaUserRequest{}
	if !nilDiffers {
...
func (m *KafkaUserRequest) WithChanges(u UpdateKafkaUserRequest) KafkaUserRequest {
	var out KafkaUserRequest
	if m != nil {
		out = *m
	}
...
// Diff creates an object that can be used in Update methods. This object represents changes from src to the current state
func (m *KafkaUserMetadataRequest) Diff(src *KafkaUserMetadataRequest) UpdateKafkaUserMetadataRequest {
	nilDiffers := src != nil && m == nil
	upd := UpdateKafkaUserMetadataRequest{}
	if !nilDiffers {
...
func (m *KafkaUserMetadataRequest) WithChanges(u UpdateKafkaUserMetadataRequest) KafkaUserMetadataRequest {
	var out KafkaUserMetadataRequest
	if m != nil {
		out = *m
	}
...
// HasChanges returns true if any field has Set == true
func (m UpdateKafkaUserMetadataRequest) HasChanges() bool {
