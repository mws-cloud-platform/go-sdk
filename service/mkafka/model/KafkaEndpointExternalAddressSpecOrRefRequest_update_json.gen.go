...
func (m UpdateKafkaEndpointExternalAddressSpecOrRefRequest) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
...
func (m *UpdateKafkaEndpointExternalAddressSpecOrRefRequest) Encode(e *jx.Encoder) error {
	if m == nil {
		e.Null()
		return nil
	}
...
func (m *UpdateKafkaEndpointExternalAddressSpecOrRefRequest) encodeFields(e *jx.Encoder) error {
	if m.Ref.IsSet() {
		e.FieldStart("ref")
...
func (m *UpdateKafkaEndpointExternalAddressSpecOrRefRequest) UnmarshalJSON(b []byte) error {
	return m.Decode(jx.DecodeBytes(b))
}

func (m *UpdateKafkaEndpointExternalAddressSpecOrRefRequest) Decode(d *jx.Decoder) error {
	if m == nil {
		return conv.NewDecodeToNilError("UpdateKafkaEndpointExternalAddressSpecOrRefRequest")
	}
