...
func (m KafkaTopicPageResponse) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
...
func (m *KafkaTopicPageResponse) Encode(e *jx.Encoder) error {
	if m == nil {
		e.Null()
		return nil
	}
...
func (m *KafkaTopicPageResponse) encodeFields(e *jx.Encoder) error {
	e.FieldStart("items")
	e.ArrStart()
...
func (m *KafkaTopicPageResponse) UnmarshalJSON(b []byte) error {
	return m.Decode(jx.DecodeBytes(b))
}

func (m *KafkaTopicPageResponse) Decode(d *jx.Decoder) error {
	if m == nil {
		return conv.NewDecodeToNilError("KafkaTopicPageResponse")
	}

	return d.ObjBytes(reserrors.PathAccumulatorErrorObjBytesFuncWrap(func(d *jx.Decoder, k []byte) error {
		switch string(k) {
		case "items":
			c := make([]KafkaTopicResponse, 0)
			if err := d.Arr(reserrors.PathAccumulatorErrorAsIndexArrFuncWrap(func(d *jx.Decoder) error {
				var v KafkaTopicResponse
