...
func decodeListEgressNatsResponse(resp *http.Response) (*client.ListEgressNatsResponse, error) {
	...
	case 200:
		...
		case "application/json":
			result := &client.ListEgressNatsResponse{
...
func decodeDeleteEgressNatResponse(resp *http.Response) (*client.DeleteEgressNatResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	switch resp.StatusCode {
	case 204:
		result := &client.DeleteEgressNatResponse{
			Code:        resp.StatusCode,
			Response204: true,
		}
...
func decodeGetEgressNatResponse(resp *http.Response) (*client.GetEgressNatResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.GetEgressNatResponse{
				Code:        resp.StatusCode,
...
func decodeUpsertEgressNatResponse(resp *http.Response) (*client.UpsertEgressNatResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.UpsertEgressNatResponse{
				Code:        resp.StatusCode,
				Response200: &model.EgressNatOptionalResponse{},
			}
