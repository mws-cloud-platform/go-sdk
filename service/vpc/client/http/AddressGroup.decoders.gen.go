...
func decodeListAddressGroupsResponse(resp *http.Response) (*client.ListAddressGroupsResponse, error) {
	...
	case 200:
		...
		case "application/json":
			result := &client.ListAddressGroupsResponse{
...
func decodeDeleteAddressGroupResponse(resp *http.Response) (*client.DeleteAddressGroupResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	switch resp.StatusCode {
	case 204:
		result := &client.DeleteAddressGroupResponse{
			Code:        resp.StatusCode,
			Response204: true,
		}
...
func decodeGetAddressGroupResponse(resp *http.Response) (*client.GetAddressGroupResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.GetAddressGroupResponse{
				Code:        resp.StatusCode,
...
func decodeUpsertAddressGroupResponse(resp *http.Response) (*client.UpsertAddressGroupResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.UpsertAddressGroupResponse{
				Code:        resp.StatusCode,
				Response200: &model.VpcAddressGroupOptionalResponse{},
			}
