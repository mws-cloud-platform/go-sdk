...
func decodeListNetworksResponse(resp *http.Response) (*client.ListNetworksResponse, error) {
	...
	case 200:
		...
		case "application/json":
			result := &client.ListNetworksResponse{
...
func decodeDeleteNetworkResponse(resp *http.Response) (*client.DeleteNetworkResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	switch resp.StatusCode {
	case 204:
		result := &client.DeleteNetworkResponse{
			Code:        resp.StatusCode,
			Response204: true,
		}
...
func decodeGetNetworkResponse(resp *http.Response) (*client.GetNetworkResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.GetNetworkResponse{
				Code:        resp.StatusCode,
...
func decodeUpsertNetworkResponse(resp *http.Response) (*client.UpsertNetworkResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.UpsertNetworkResponse{
				Code:        resp.StatusCode,
				Response200: &model.NetworkOptionalResponse{},
			}
