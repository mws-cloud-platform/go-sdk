...
func decodeListRoutesResponse(resp *http.Response) (*client.ListRoutesResponse, error) {
	...
	case 200:
		...
		case "application/json":
			result := &client.ListRoutesResponse{
...
func decodeDeleteRouteResponse(resp *http.Response) (*client.DeleteRouteResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
...
func decodeGetRouteResponse(resp *http.Response) (*client.GetRouteResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
...
func decodeUpsertRouteResponse(resp *http.Response) (*client.UpsertRouteResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.UpsertRouteResponse{
				Code:        resp.StatusCode,
				Response200: &model.RouteOptionalResponse{},
			}
