...
func decodeListOneToOneNatsResponse(resp *http.Response) (*client.ListOneToOneNatsResponse, error) {
	...
	case 200:
		...
		case "application/json":
			result := &client.ListOneToOneNatsResponse{
...
func decodeDeleteOneToOneNatResponse(resp *http.Response) (*client.DeleteOneToOneNatResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	switch resp.StatusCode {
	case 204:
		result := &client.DeleteOneToOneNatResponse{
			Code:        resp.StatusCode,
			Response204: true,
		}
...
func decodeGetOneToOneNatResponse(resp *http.Response) (*client.GetOneToOneNatResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.GetOneToOneNatResponse{
				Code:        resp.StatusCode,
...
func decodeUpsertOneToOneNatResponse(resp *http.Response) (*client.UpsertOneToOneNatResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.UpsertOneToOneNatResponse{
				Code:        resp.StatusCode,
				Response200: &model.OneToOneNatOptionalResponse{},
			}
