...
func decodeListSubnetsResponse(resp *http.Response) (*client.ListSubnetsResponse, error) {
...
func decodeDeleteSubnetResponse(resp *http.Response) (*client.DeleteSubnetResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
...
func decodeGetSubnetResponse(resp *http.Response) (*client.GetSubnetResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
...
func decodeUpsertSubnetResponse(resp *http.Response) (*client.UpsertSubnetResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
