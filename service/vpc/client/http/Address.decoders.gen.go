...
func decodeListAddressesResponse(resp *http.Response) (*client.ListAddressesResponse, error) {
	...
	case 200:
		...
		case "application/json":
			result := &client.ListAddressesResponse{
...
func decodeDeleteAddressResponse(resp *http.Response) (*client.DeleteAddressResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	switch resp.StatusCode {
	case 204:
		result := &client.DeleteAddressResponse{
			Code:        resp.StatusCode,
			Response204: true,
		}
...
func decodeGetAddressResponse(resp *http.Response) (*client.GetAddressResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.GetAddressResponse{
				Code:        resp.StatusCode,
...
func decodeUpsertAddressResponse(resp *http.Response) (*client.UpsertAddressResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.UpsertAddressResponse{
				Code:        resp.StatusCode,
				Response200: &model.AddressOptionalResponse{},
			}
