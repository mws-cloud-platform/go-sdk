...
func decodeListFirewallRulesResponse(resp *http.Response) (*client.ListFirewallRulesResponse, error) {
...
func decodeDeleteFirewallRuleResponse(resp *http.Response) (*client.DeleteFirewallRuleResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
...
func decodeGetFirewallRuleResponse(resp *http.Response) (*client.GetFirewallRuleResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
...
func decodeUpsertFirewallRuleResponse(resp *http.Response) (*client.UpsertFirewallRuleResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
