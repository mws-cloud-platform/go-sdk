...
func (m RouteRequest) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
...
func (m *RouteRequest) Encode(e *jx.Encoder) error {
	if m == nil {
		e.Null()
		return nil
	}
...
func (m *RouteRequest) encodeFields(e *jx.Encoder) error {
	if m.Metadata != nil {
...
func (m *RouteRequest) UnmarshalJSON(b []byte) error {
	return m.Decode(jx.DecodeBytes(b))
}

func (m *RouteRequest) Decode(d *jx.Decoder) error {
	if m == nil {
		return conv.NewDecodeToNilError("RouteRequest")
	}
