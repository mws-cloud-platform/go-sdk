...
func (m *EgressNatSpecRequest) SetPba(val *EgressNatSpecPbaRequest) {
	m.Pba = val
}

func (m *EgressNatSpecRequest) GetPbaOr(val EgressNatSpecPbaRequest) EgressNatSpecPbaRequest {
	if m != nil && m.Pba != nil {
		return *m.Pba
	}
	return val
