...
func (m *RouteOptionalResponse) SetKind(val *string) {
	m.Kind = val
}

func (m *RouteOptionalResponse) GetKindOr(val string) string {
	if m != nil && m.Kind != nil {
		return *m.Kind
	}
	return val
...
func (m *RouteOptionalResponse) GetSpec() RouteSpecOptionalResponse {
	if m != nil {
		return m.Spec
	}
	return RouteSpecOptionalResponse{}
}

func (m *RouteOptionalResponse) SetSpec(val RouteSpecOptionalResponse) {
	m.Spec = val
}

func (m *RouteOptionalResponse) GetStatus() *RouteStatusResponse {
	if m != nil {
		return m.Status
	}
	return nil
...
func (m *RouteOptionalResponse) SetStatus(val *RouteStatusResponse) {
	m.Status = val
}

func (m *RouteOptionalResponse) GetStatusOr(val RouteStatusResponse) RouteStatusResponse {
...
func (m *RouteOptionalResponse) Clone() *RouteOptionalResponse {
	if m == nil {
		return nil
	}
...
func (m *RouteOptionalResponse) Parse(ctx context.Context) error {
	if m == nil {
		return nil
	}
...
func (m *RouteOptionalResponse) Decode(d *jx.Decoder) error {
	if m == nil {
		return conv.NewDecodeToNilError("RouteOptionalResponse")
	}
	...
	return d.ObjBytes(reserrors.PathAccumulatorErrorObjBytesFuncWrap(func(d *jx.Decoder, k []byte) error {
		...
		case "metadata":
			...
			return nil
		case "spec":
			var v RouteSpecOptionalResponse
			if err := v.Decode(d); err != nil {
				return err
			}
