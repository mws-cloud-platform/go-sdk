...
func decodeLatestImageResponse(resp *http.Response) (*client.LatestImageResponse, error) {
	...
	case 200:
		...
		case "application/json":
			result := &client.LatestImageResponse{
...
func decodeListImagesResponse(resp *http.Response) (*client.ListImagesResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.ListImagesResponse{
				Code:        resp.StatusCode,
				Response200: &client.ListImagesResponse200{},
			}
...
func decodeDeleteImageResponse(resp *http.Response) (*client.DeleteImageResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	switch resp.StatusCode {
	case 204:
		result := &client.DeleteImageResponse{
			Code:        resp.StatusCode,
			Response204: true,
		}
...
func decodeGetImageResponse(resp *http.Response) (*client.GetImageResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.GetImageResponse{
				Code:        resp.StatusCode,
				Response200: &model.ImageOptionalResponse{},
			}
...
func decodeUpsertImageResponse(resp *http.Response) (*client.UpsertImageResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.UpsertImageResponse{
				Code:        resp.StatusCode,
				Response200: &model.ImageOptionalResponse{},
			}
