...
func decodeListVirtualMachinesResponse(resp *http.Response) (*client.ListVirtualMachinesResponse, error) {
...
func decodeDeleteVirtualMachineResponse(resp *http.Response) (*client.DeleteVirtualMachineResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
...
func decodeGetVirtualMachineResponse(resp *http.Response) (*client.GetVirtualMachineResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
...
func decodeUpsertVirtualMachineResponse(resp *http.Response) (*client.UpsertVirtualMachineResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
