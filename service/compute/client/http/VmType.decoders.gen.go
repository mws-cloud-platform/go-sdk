...
func decodeListVmTypesResponse(resp *http.Response) (*client.ListVmTypesResponse, error) {
...
func decodeGetVmTypeResponse(resp *http.Response) (*client.GetVmTypeResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
