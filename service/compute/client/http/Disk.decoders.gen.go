...
func decodeListDisksResponse(resp *http.Response) (*client.ListDisksResponse, error) {
	...
	case 200:
		...
		case "application/json":
			result := &client.ListDisksResponse{
				...
				Response200: &client.ListDisksResponse200{},
			}
...
func decodeDeleteDiskResponse(resp *http.Response) (*client.DeleteDiskResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
...
func decodeGetDiskResponse(resp *http.Response) (*client.GetDiskResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
...
func decodeUpsertDiskResponse(resp *http.Response) (*client.UpsertDiskResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
