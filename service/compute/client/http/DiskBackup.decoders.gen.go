...
func decodeListDiskBackupsResponse(resp *http.Response) (*client.ListDiskBackupsResponse, error) {
	...
	case 200:
		...
		case "application/json":
			result := &client.ListDiskBackupsResponse{
				Code:        resp.StatusCode,
				Response200: &client.ListDiskBackupsResponse200{},
			}
...
func decodeDeleteDiskBackupResponse(resp *http.Response) (*client.DeleteDiskBackupResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	switch resp.StatusCode {
	case 204:
		result := &client.DeleteDiskBackupResponse{
			Code:        resp.StatusCode,
			Response204: true,
		}
...
func decodeGetDiskBackupResponse(resp *http.Response) (*client.GetDiskBackupResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.GetDiskBackupResponse{
				Code:        resp.StatusCode,
...
func decodeUpsertDiskBackupResponse(resp *http.Response) (*client.UpsertDiskBackupResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
	...
	case 200:
		switch ct {
		case "application/json":
			result := &client.UpsertDiskBackupResponse{
				Code:        resp.StatusCode,
				Response200: &model.DiskBackupOptionalResponse{},
			}
