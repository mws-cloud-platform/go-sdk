...
func (m *SnapshotStatusResponse) GetEncryption() *EncryptionStatusResponse {
	if m != nil {
		return m.Encryption
	}
	return nil
...
func (m *SnapshotStatusResponse) GetEncryptionOr(val EncryptionStatusResponse) EncryptionStatusResponse {
