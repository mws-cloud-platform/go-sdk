...
func (m *UpdateStorageDiskSpecRequest) Encode(e *jx.Encoder) {
	if m == nil {
		e.Null()
		return
	}
...
func (m *UpdateStorageDiskSpecRequest) encodeFields(e *jx.Encoder) {
	if m.Size.IsSet() {
		e.FieldStart("size")
...
func (m *UpdateStorageDiskSpecRequest) UnmarshalJSON(b []byte) error {
	return m.Decode(jx.DecodeBytes(b))
}

func (m *UpdateStorageDiskSpecRequest) Decode(d *jx.Decoder) error {
	if m == nil {
		return conv.NewDecodeToNilError("UpdateStorageDiskSpecRequest")
	}
...
func (m *UpdateStorageDiskSpecSourceRequest) Encode(e *jx.Encoder) {
	if m == nil {
		e.Null()
		return
	}
...
func (m *UpdateStorageDiskSpecSourceRequest) encodeFields(e *jx.Encoder) {
	if m.Image.IsSet() {
		e.FieldStart("image")
