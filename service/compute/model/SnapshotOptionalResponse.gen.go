...
func (m SnapshotOptionalResponse) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
...
func (m *SnapshotOptionalResponse) Encode(e *jx.Encoder) error {
	if m == nil {
		e.Null()
		return nil
	}
...
func (m *SnapshotOptionalResponse) encodeFields(e *jx.Encoder) error {
	if m.Kind != nil {
		e.FieldStart("kind")
		e.Str(*m.Kind)
	}
...
func (m *SnapshotOptionalResponse) UnmarshalJSON(b []byte) error {
	return m.Decode(jx.DecodeBytes(b))
}

func (m *SnapshotOptionalResponse) Decode(d *jx.Decoder) error {
	if m == nil {
		return conv.NewDecodeToNilError("SnapshotOptionalResponse")
	}
	...
	return d.ObjBytes(reserrors.PathAccumulatorErrorObjBytesFuncWrap(func(d *jx.Decoder, k []byte) error {
		...
		case "metadata":
			...
			return nil
		case "spec":
			var v SnapshotSpecOptionalResponse
			if err := v.Decode(d); err != nil {
				return err
			}
