...
func decodeListModelsResponse(resp *http.Response) (*client.ListModelsResponse, error) {
	...
	case 200:
		...
		case "application/json":
			result := &client.ListModelsResponse{
				...
				Response200: &client.ListModelsResponse200{},
			}
...
func decodeGetModelResponse(resp *http.Response) (*client.GetModelResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
