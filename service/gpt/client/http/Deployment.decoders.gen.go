...
func decodeListDeploymentsResponse(resp *http.Response) (*client.ListDeploymentsResponse, error) {
	...
	case 200:
		...
		case "application/json":
			result := &client.ListDeploymentsResponse{
				...
				Response200: &client.ListDeploymentsResponse200{},
			}
...
func decodeDeleteDeploymentResponse(resp *http.Response) (*client.DeleteDeploymentResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
...
func decodeGetDeploymentResponse(resp *http.Response) (*client.GetDeploymentResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
...
func decodeUpsertDeploymentResponse(resp *http.Response) (*client.UpsertDeploymentResponse, error) {
	ct, err := commonclient.GetContentType(resp)
	if err != nil {
		return nil, err
	}
